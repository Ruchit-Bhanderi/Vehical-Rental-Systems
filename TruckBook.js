...
const TruckBook = () => {
  ...
  useEffect(() => {
    Axios.get(`http://localhost:8000/uservehicledata/${id}`)
      .then((res) => {
        setTruck(res.data.vehicledata)
        // console.log("setbike", res.data.bikedata);
      })
  ...
  const totalamount = Difference_In_Days * truck.amount;
  ...
  let adata = feedback.filter((i) => {
    return i.Booking[0].Vehicle.includes(truck._id)
  })
  ...
  return (
    <>
      ...
      <div className="container-fuild containerbooks">
        {truck ? (<div className="row bikebook ">
          <div className="col-xl-2 col-12">
            <Card className="cardbook">
              <Card.Img variant="top" src={truck.vehicleimage} />
              <p className="model">Name : {truck.name}</p>
              <p className="model">Type : {truck.type}</p>
              <p className="model">Number : {truck.number}</p>
              <p className="model">Mileage : {truck.milege}</p>
              <p className="model">Amount : {truck.amount}</p>
          ...
          <p className="bookhs2">This truck is Not avilable</p>
        )}
      ...
      {isOpen && (
        <>
          ...
          >
            <div>
              <h5 className="">This Bike is Already booked, So please choose another truck..!</h5>
              <NavLink className="nav-link" exact to="/truck">
