...
const Car = () => {
  ...
  const handleClick = (e) => {
    ...
    if (filter.rent && filter.brand) {
      ...
      let filters = data.filter((i) => {
        console.log("i.caramount <= e.target.value", i.amount <= filter.rent)
      ...
      let filters = data.filter((i) => {
        console.log("i", i)
        console.log("i.companyname.include(filter.brand)", i.companyname)
      ...
      <div>
        <div className="navbar bikes-navbars">
          ...
          >
            ...
            <option className="optionns">Suzuki</option>
            <option className="optionns">Tata</option>
            <option className="optionns">Honda</option>
            <option className="optionns">Hyunda</option>
          </select>
                      ...
                      <div className="container ">
                        <div className="row ">
                          ...
                          <div className="col-xl-4 col-12 iiimmmmg">
                            <img className="iiimges" src={car.vehicleimage} />
                          </div>
